...
const MCPConsole = ({ availableMCPs }) => {
  const [selectedMCP, setSelectedMCP] = reactExports.useState(availableMCPs[0] || "");
  const [prompt, setPrompt] = reactExports.useState("");
  const [response, setResponse] = reactExports.useState("");
  const handleSend = async () => {
    if (!selectedMCP) {
      setResponse("❌ No hay MCP seleccionado.");
      return;
    }
    try {
      const res = await window.electronAPI.sendPrompt(selectedMCP, prompt);
      setResponse(res);
    } catch (err) {
      setResponse(`Error: ${err instanceof Error ? err.message : String(err)}`);
    }
  };
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "mt-8", children: [
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "mb-2", children: [
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("label", { htmlFor: "mcp-select", className: "mr-2 font-semibold", children: "MCP:" }, void 0, false, {
      ...
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
        "select",
        {
          ...
          children: availableMCPs.map((name) => /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("option", { value: name, children: name }, name, false, {
            fileName: "/Users/tomasmaritano/Documents/inkrun/inkrun/my-electron-vite-project/src/components/MCPManager.tsx",
            lineNumber: 45,
            columnNumber: 13
          }, void 0))
    ...
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("pre", { className: "mt-4 p-2 bg-gray-100 rounded whitespace-pre-wrap", children: response }, void 0, false, {
      fileName: "/Users/tomasmaritano/Documents/inkrun/inkrun/my-electron-vite-project/src/components/MCPManager.tsx",
      lineNumber: 62,
      columnNumber: 7
    }, void 0)
...
function App() {
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(jsxDevRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(MCPConsole, {}, void 0, false, {
