...
const Button = () => {
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("button", { className: "p-2 m-2 border-gray-300", children: "Github" }, void 0, false, {
...
const Welcome = () => {
  ...
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex items-center justify-center h-screen bg-zinc-900 text-white", children: [
