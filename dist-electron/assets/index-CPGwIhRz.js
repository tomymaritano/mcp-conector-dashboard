...
const MCPConsole = () => {
  ...
  const handleSend = async () => {
    var _a;
    try {
      if ((_a = window.electronAPI) == null ? void 0 : _a.sendPrompt) {
        const res = await window.electronAPI.sendPrompt(prompt);
        setResponse(res);
      } else {
        setResponse("Error: sendPrompt API is not available.");
      }
    } catch (err) {
      console.error("Error sending prompt to MCP:", err);
  ...
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { children: [
    ...
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("button", { onClick: handleSend, children: "Send" }, void 0, false, {
      fileName: "/Users/tomasmaritano/Documents/inkrun/inkrun/my-electron-vite-project/src/components/MCPConsole.tsx",
      lineNumber: 36,
      columnNumber: 7
    }, void 0),
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("pre", { children: response }, void 0, false, {
      fileName: "/Users/tomasmaritano/Documents/inkrun/inkrun/my-electron-vite-project/src/components/MCPConsole.tsx",
      lineNumber: 37,
      columnNumber: 7
    }, void 0)
...
const MCPManager = () => {
  ...
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "p-6 max-w-4xl mx-auto", children: [
    ...
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(MCPConsole, { availableMCPs: servers.filter((s) => s.status === "online").map((s) => s.name) }, void 0, false, {
      fileName: "/Users/tomasmaritano/Documents/inkrun/inkrun/my-electron-vite-project/src/components/MCPManager.tsx",
      lineNumber: 113,
      columnNumber: 1
    }, void 0)
