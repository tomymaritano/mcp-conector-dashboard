...
const MCPConsole = () => {
  ...
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-col w-full max-w-2xl mx-auto mt-6 bg-white dark:bg-gray-900 rounded-lg shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700", children: [
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-col gap-4 p-4 h-96 overflow-y-auto", children: [
      messages.map((msg, idx) => /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
        "div",
        {
          className: `whitespace-pre-wrap px-4 py-2 rounded-md max-w-[80%] ${msg.role === "user" ? "bg-blue-500 text-white self-end" : "bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 self-start"}`,
      ...
      loading && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "self-start text-sm text-gray-500 italic", children: "⌛ Pensando..." }, void 0, false, {
        fileName: "/Users/tomasmaritano/Documents/inkrun/inkrun/my-electron-vite-project/src/components/MCPConsole.tsx",
        lineNumber: 58,
        columnNumber: 11
      }, void 0)
    ...
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex items-center border-t border-gray-200 dark:border-gray-700 p-4", children: [
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
        "textarea",
        {
          className: "flex-1 resize-none p-2 rounded border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-sm text-gray-800 dark:text-gray-100 focus:outline-none",
          rows: 2,
